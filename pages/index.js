      ...
      <main className="w-full p-10 lg:p-20 flex items-center justify-center">
        <div className="w-full md:w-[400px] flex flex-col items-center">
          ...
          <form className='w-full mb-8 lg:mb-16'>
            ...
            <input type="text" name="name" placeholder='Seu nome aqui' className='w-full border border-[#C1C1C1] px-4 py-3 rounded-lg mt-2 mb-5'></input>

            <label for="phone" className='block font-bold'>
              Telefone
            </label>
            <input type="tel" name="phone" placeholder='(DDD) 9 9999-9999' className='w-full border border-[#C1C1C1] px-4 py-3 rounded-lg mt-2 mb-5'></input>

            <label for="mail" className='block font-bold'>
              E-mail
            </label>
            <input type="mail" name="mail" placeholder='email@email.com' className='w-full border border-[#C1C1C1] px-4 py-3 rounded-lg mt-2 mb-5'></input>
            ...
            <input type="password" name="password" placeholder='**********' className='w-full border border-[#C1C1C1] px-4 py-3 rounded-lg mt-2 mb-5'></input>
          ...
          <p className='mb-5'>Já tem uma conta? <a href="" className='text-blue-700 underline'>Entre aqui</a> </p>
        </div>
      </main>
